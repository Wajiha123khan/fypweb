...
class StudentsNotificationScreen extends StatefulWidget {
  const StudentsNotificationScreen({super.key});

  @override
  State<StudentsNotificationScreen> createState() =>
      _StudentsNotificationScreenState();
}

class _StudentsNotificationScreenState
    extends State<StudentsNotificationScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<NotificationM>>(
          stream: filterNotifications(
